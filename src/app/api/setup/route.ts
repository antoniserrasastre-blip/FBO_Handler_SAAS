...
const schema = [
  ...
  `CREATE TABLE IF NOT EXISTS "Flight" ("id" TEXT NOT NULL PRIMARY KEY, "daySheetId" TEXT NOT NULL, "callsign" TEXT NOT NULL, "registration" TEXT NOT NULL, "aircraftType" TEXT NOT NULL, "origin" TEXT, "eta" TEXT, "arrivalDate" TEXT, "destination" TEXT, "etd" TEXT, "departureDate" TEXT, "parking" TEXT, "tobt" TEXT, "state" TEXT NOT NULL DEFAULT 'EXPECTED', "crewArrival" INTEGER NOT NULL DEFAULT 0, "paxArrival" INTEGER NOT NULL DEFAULT 0, "crewDeparture" INTEGER NOT NULL DEFAULT 0, "paxDeparture" INTEGER NOT NULL DEFAULT 0, "paxArrBagsChecked" INTEGER NOT NULL DEFAULT 0, "paxArrBagsCabin" INTEGER NOT NULL DEFAULT 0, "paxArrBagsState" TEXT NOT NULL DEFAULT 'IN_AIRCRAFT', "paxArrTransportType" TEXT NOT NULL DEFAULT 'UNDEFINED', "paxArrTransportState" TEXT NOT NULL DEFAULT 'PENDING', "paxArrState" TEXT NOT NULL DEFAULT 'IN_AIRCRAFT', "paxDepBagsChecked" INTEGER NOT NULL DEFAULT 0, "paxDepBagsCabin" INTEGER NOT NULL DEFAULT 0, "paxDepBagsState" TEXT NOT NULL DEFAULT 'NOT_ARRIVED', "paxDepTransportType" TEXT NOT NULL DEFAULT 'UNDEFINED', "paxDepTransportState" TEXT NOT NULL DEFAULT 'PENDING', "paxDepState" TEXT NOT NULL DEFAULT 'NOT_ARRIVED', "crewArrLocation" TEXT NOT NULL DEFAULT 'IN_AIRCRAFT', "crewDepLocation" TEXT NOT NULL DEFAULT 'IN_AIRCRAFT', "fuelState" TEXT NOT NULL DEFAULT 'NOT_REQUESTED', "fuelRequestedAt" TEXT, "fuelServedAt" TEXT, "toiletState" TEXT NOT NULL DEFAULT 'NOT_REQUESTED', "toiletRequestedAt" TEXT, "toiletCompletedAt" TEXT, "crewArrivalReal" INTEGER, "crewDepartureReal" INTEGER, "paxArrivalReal" INTEGER, "paxDepartureReal" INTEGER, "linkedFlightId" TEXT, "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, "updatedAt" DATETIME NOT NULL, CONSTRAINT "Flight_daySheetId_fkey" FOREIGN KEY ("daySheetId") REFERENCES "DaySheet" ("id") ON DELETE CASCADE ON UPDATE CASCADE)`,
  `CREATE INDEX IF NOT EXISTS "Flight_daySheetId_idx" ON "Flight"("daySheetId")`,
  `CREATE TABLE IF NOT EXISTS "Service" ("id" TEXT NOT NULL PRIMARY KEY, "flightId" TEXT NOT NULL, "type" TEXT NOT NULL, "customName" TEXT, "reference" TEXT, "state" TEXT NOT NULL DEFAULT 'PENDING', "origin" TEXT, "arrivedAt" TEXT, "deliveredAt" TEXT, "target" TEXT, "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, "updatedAt" DATETIME NOT NULL, CONSTRAINT "Service_flightId_fkey" FOREIGN KEY ("flightId") REFERENCES "Flight" ("id") ON DELETE CASCADE ON UPDATE CASCADE)`,
...
export async function GET() {
  ...
  try {
    ...
    const migrations = [
      ...
      `ALTER TABLE "Flight" ADD COLUMN "crewArrivalReal" INTEGER`,
      `ALTER TABLE "Flight" ADD COLUMN "crewDepartureReal" INTEGER`,
